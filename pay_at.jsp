...
String pay_at_hospi_id=(String)request.getParameter("pay_at_hospi_id");
try {
...
String QueryString = "SELECT * from tfest where pay_at_hospi_id='"+pay_at_hospi_id+"'";
...
//String phone=(String)rs.getString(1);
